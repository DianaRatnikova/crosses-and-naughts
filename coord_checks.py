...
def check_if_cell_is_empty(list_game_board: list[list[str|None]], player_coord_tuple: tuple[int, int]) -> bool:
...
def check_coord_is_ok(coordinate: int|str) -> bool:
     return isinstance(coordinate, int) and coordinate >= 0 and coordinate <= constants.N-1
